...
(
    ...
    tipoPlano char(1) not null,-- check (tipoPlano in ('f','p','e')),
    usuario char(15) not null unique,
    endereco varchar(150),
    cpf char(11) unique,
    vinculoIE date,
    familiar1 char(15),-- check (tipoPlano = 'f'),
    familiar2 char(15),-- check (tipoPlano = 'f'),
    familiar3 char(15),-- check (tipoPlano = 'f'),
    familiar4 char(15),-- check (tipoPlano = 'f'),
    familiar5 char(15),-- check (tipoPlano = 'f'),
...
(
    ...
    faturaPaga boolean not null default false,
...
create table PROGRAMA_SEGUIDO
(
    codUsuario char(15) not null,
    codProg char(15) not null,
    primary key(codUsuario, codProg),
    foreign key(codUsuario) references USUARIO
        on delete cascade
        on update cascade,
    foreign key(codProg) references PROGRAMA
        on delete cascade
        on update cascade
);
